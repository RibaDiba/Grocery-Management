...
export function CalendarOverlay({ isOpen, onClose, token }: CalendarOverlayProps) {
    ...
    >
      <div className="px-4 pt-6 flex items-center gap-3">
        ...
        <div className="flex-1">
          <div
            className="flex items-center gap-3 rounded-full bg-white/90 px-4 py-2 shadow-lg"
          >
            <button
              type="button"
