...
export default function CalendarOverlay({
  ...
  return (
    ...
    >
      ...
      <nav
        className="absolute inset-x-4 bottom-4 flex items-center justify-between rounded-full bg-white px-6 py-3 shadow-lg"
        style={{ color: '#354A33' }}
      >
        <button
          type="button"
          ...
          style={{ backgroundColor: '#E6F2E4', color: '#1F2A1C' }}
        >
        ...
        >
          ...
          <span className="text-xs font-medium">{addReceiptLabel}</span>
        </button>
